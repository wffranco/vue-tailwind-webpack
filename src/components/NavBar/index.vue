<template>
  <div class="relative" :class="nav.primary">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 py-6 md:justify-start md:space-x-10" :class="nav.border">
        ...
        <nav class="hidden md:flex space-x-6">
          <DropDown :text="t('solutions')" transition="fly">
            <template #default="{close}">
              <div class="relative grid gap-6 px-5 py-6 sm:gap-8 sm:p-8" :class="nav.submenu.primary">
                ...
                <a href="#" class="-m-3 p-3 flex items-start rounded-lg" :class="nav.submenu.item.primary">
              ...
              <div class="px-5 py-5 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8" :class="nav.submenu.secondary">
                <div class="flow-root">
                  <a href="#" class="-m-3 p-3 flex items-center rounded-md text-base font-medium" :class="nav.submenu.item.secondary">
                    <!-- Heroicon name: play -->
                    <svg
                      class="flex-shrink-0 h-6 w-6"
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <DropDown :text="t('more')" transition="fly">
            <template #default>
              ...
              <div class="px-5 py-5 sm:px-8 sm:py-8" :class="nav.submenu.secondary">
                <div>
                  <h3 class="text-sm tracking-wide font-medium uppercase">
                    Recent Posts
                  </h3>
                  <ul class="mt-4 space-y-4">
                    <li class="text-base truncate text-gray-900 hover:text-gray-700 dark:hover:text-gray-800">
        ...
        <DropDown transition="mobile" class="md:hidden -mr-2 -my-2" dropdown-class="left-0 top-0 w-screen">
          <template #button="{toggle}">
            <button
              type="button"
              class="rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 dark:focus:ring-indigo-500"
              @click="toggle"
            >
